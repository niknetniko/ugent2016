...
\begin{document}
    ...
    Deze handleiding is in het Nederlands. Een Engelse variant is in opbouw.
...
\includegraphics[width=3\smallblock]{\ugentkortrijk}
    ...
    \begin{center}
        \frame{\includegraphics[width=1\textwidth]{frontpages/ugent2016title-course.pdf}}
    \end{center}

    \section{Voorblad met stijl \texttt{report}}\label{sec:voorblad-met-stijl-report}
    \begin{center}
        \frame{\includegraphics[width=1\textwidth]{frontpages/ugent2016title-report.pdf}}
    \end{center}

    \section{Voorblad met stijl \texttt{notes}}\label{sec:voorblad-met-stijl-notes}
    \begin{center}
        \frame{\includegraphics[width=1\textwidth]{frontpages/ugent2016title-notes.pdf}}
    \end{center}
