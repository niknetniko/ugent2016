...
\includegraphics[width=3\smallblock]{\ugentkortrijk}
    ...
    Dit onderdeel bevat de voornaamste wijzigingen. De exacte wijzigingen kunnen gevonden worden in de Github-repository.

    \subsubsection*{22 mei 2019}
    \begin{itemize}
        \item Uniforme naamgeving van de pakketten en klassen.
        \item Commando's hernoemd met uniformere naam.
        \item Toevoegen \emph{wrapper}-klassen \texttt{ugent2016-report}, \texttt{ugent2016-article} en \texttt{ugent2016-book}.
    \end{itemize}
