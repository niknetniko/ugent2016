...
\end{minted}
    ...
    De drie klasse van hierboven gebruiken achter de schermen dezelfde basisklasse: \texttt{ugent20160}. Deze klasse is ook bruikbaar indien gewenst.
    ...
    De klasse maakt gebruik van het pakket \texttt{ugent2016-style} om het voorblad te voorzien. Zie de beschrijving van de opties aldaar. In het bijzonder is tabel~\ref{table:titlemeta} interessant.

    \section{Pakket \texttt{ugen2016-style}}\label{sec:pakkettexttt}
...
\ugentfacultyname{re}
    ...
    Pakketten zoals \texttt{ugent2016-style} gebruiken deze basisgrootte om de positie van onderdelen te bepalen.
